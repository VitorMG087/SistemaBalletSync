...
[Route("relatorio")]
[ApiController]
public class RelatorioRecebimentoController : ControllerBase
{
    private readonly IConverter _converter;
    private readonly AlunoService _alunoService;
    private readonly RecebimentoService _recebimentoService;

    public RelatorioRecebimentoController(IConverter converter, AlunoService alunoService, RecebimentoService recebimentoService)
    {
    ...
    public async Task<IActionResult> GerarPdfRecebimentos(int mes, int ano)
    {
        ...
        var tituloColuna2 = string.IsNullOrEmpty(relatorio.Coluna2) ? "Valor" : relatorio.Coluna2;
        var tituloColuna3 = string.IsNullOrEmpty(relatorio.Coluna3) ? "Status" : relatorio.Coluna3;
...
<body>
  <div id='container'>
    ...
    <h1 class='titulo-relatorio'>Relatório de Recebimentos - {mes:00}/{ano}</h1>
    ...
    <footer>
      © 2025 Escola de Ballet - Todos os Direitos Reservados.
        ...
        return File(pdf, "application/pdf", $"Relatorio_Recebimentos_{mes}_{ano}.pdf");
    }
}
