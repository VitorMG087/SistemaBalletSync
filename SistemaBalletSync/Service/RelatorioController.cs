...
{
    [HttpGet("obter-recebimentos")]
    public async Task<IActionResult> ObterRecebimentos()
    {
        var recebimentos = await _recebimentoService.GetAllRecebimentosAsync();
    ...
    public RelatorioController(AlunoService alunoService, RecebimentoService recebimentoService)
    {
        _alunoService = alunoService;
